...
static inline vect128 mulByConjugate128(vect128 *a, vect128 *b, int8_t output_shift) {
  ...
  mmtmpP0b = vmull_s16(vrev32_s16(vmul_s16(((int16x4_t*)b)[0],*(int16x4_t *)conj)),  ((int16x4_t*)a)[0]);
  mmtmpP1b = vmull_s16(vrev32_s16(vmul_s16(((int16x4_t*)b)[1],*(int16x4_t *)conj)),  ((int16x4_t*)a)[1]);
