...
asn_TYPE_descriptor_t asn_DEF_NR_msgA_RO_FDM_r16_3 = {
	...
	{ 0, &asn_PER_type_NR_msgA_RO_FDM_r16_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_NR_msgA_PreamblePowerRampingStep_r16_10 = {
	...
	{ 0, &asn_PER_type_NR_msgA_PreamblePowerRampingStep_r16_constr_10, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_NR_msgB_ResponseWindow_r16_16 = {
	...
	{ 0, &asn_PER_type_NR_msgB_ResponseWindow_r16_constr_16, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_NR_preambleTransMax_r16_27 = {
	...
	{ 0, &asn_PER_type_NR_preambleTransMax_r16_constr_27, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_NR_preambleTransMax_r16_specs_27	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_NR_RACH_ConfigGenericTwoStepRA_r16_1[] = {
	{ ATF_POINTER, 8, offsetof(struct NR_RACH_ConfigGenericTwoStepRA_r16, msgA_PRACH_ConfigurationIndex_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_msgA_PRACH_ConfigurationIndex_r16_constr_2,  memb_NR_msgA_PRACH_ConfigurationIndex_r16_constraint_1 },
		0, 0, /* No default value */
		"msgA-PRACH-ConfigurationIndex-r16"
		},
	{ ATF_POINTER, 7, offsetof(struct NR_RACH_ConfigGenericTwoStepRA_r16, msgA_RO_FDM_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 6, offsetof(struct NR_RACH_ConfigGenericTwoStepRA_r16, msgA_RO_FrequencyStart_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_msgA_RO_FrequencyStart_r16_constr_8,  memb_NR_msgA_RO_FrequencyStart_r16_constraint_1 },
		0, 0, /* No default value */
		"msgA-RO-FrequencyStart-r16"
		},
	{ ATF_POINTER, 5, offsetof(struct NR_RACH_ConfigGenericTwoStepRA_r16, msgA_ZeroCorrelationZoneConfig_r16),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_msgA_ZeroCorrelationZoneConfig_r16_constr_9,  memb_NR_msgA_ZeroCorrelationZoneConfig_r16_constraint_1 },
		0, 0, /* No default value */
		"msgA-ZeroCorrelationZoneConfig-r16"
		},
	{ ATF_POINTER, 4, offsetof(struct NR_RACH_ConfigGenericTwoStepRA_r16, msgA_PreamblePowerRampingStep_r16),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct NR_RACH_ConfigGenericTwoStepRA_r16, msgA_PreambleReceivedTargetPower_r16),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_msgA_PreambleReceivedTargetPower_r16_constr_15,  memb_NR_msgA_PreambleReceivedTargetPower_r16_constraint_1 },
		0, 0, /* No default value */
		"msgA-PreambleReceivedTargetPower-r16"
		},
	{ ATF_POINTER, 2, offsetof(struct NR_RACH_ConfigGenericTwoStepRA_r16, msgB_ResponseWindow_r16),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct NR_RACH_ConfigGenericTwoStepRA_r16, preambleTransMax_r16),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_NR_RACH_ConfigGenericTwoStepRA_r16_oms_1[] = { 0, 1, 2, 3, 4, 5, 6, 7 };
