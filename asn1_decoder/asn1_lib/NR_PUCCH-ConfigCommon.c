...
asn_TYPE_descriptor_t asn_DEF_NR_pucch_GroupHopping_3 = {
	...
	{ 0, &asn_PER_type_NR_pucch_GroupHopping_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_NR_PUCCH_ConfigCommon_1[] = {
	{ ATF_POINTER, 1, offsetof(struct NR_PUCCH_ConfigCommon, pucch_ResourceCommon),
		...
		0,
		{ 0, &asn_PER_memb_NR_pucch_ResourceCommon_constr_2,  memb_NR_pucch_ResourceCommon_constraint_1 },
	...
	{ ATF_POINTER, 2, offsetof(struct NR_PUCCH_ConfigCommon, hoppingId),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_hoppingId_constr_7,  memb_NR_hoppingId_constraint_1 },
		0, 0, /* No default value */
		"hoppingId"
		},
	{ ATF_POINTER, 1, offsetof(struct NR_PUCCH_ConfigCommon, p0_nominal),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_p0_nominal_constr_8,  memb_NR_p0_nominal_constraint_1 },
		0, 0, /* No default value */
		"p0-nominal"
		},
};
static const int asn_MAP_NR_PUCCH_ConfigCommon_oms_1[] = { 0, 2, 3 };
