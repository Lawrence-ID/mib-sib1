...
asn_TYPE_descriptor_t asn_DEF_NR_npn_IdentityList_r16_2 = {
	...
	{ 0, &asn_PER_type_NR_npn_IdentityList_r16_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_NR_cellReservedForOperatorUse_r16_7 = {
	...
	{ 0, &asn_PER_type_NR_cellReservedForOperatorUse_r16_constr_7, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_NR_iab_Support_r16_10 = {
	...
	{ 0, &asn_PER_type_NR_iab_Support_r16_constr_10, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_NR_NPN_IdentityInfo_r16_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NR_NPN_IdentityInfo_r16, npn_IdentityList_r16),
		...
		0,
		{ 0, &asn_PER_memb_NR_npn_IdentityList_r16_constr_2,  memb_NR_npn_IdentityList_r16_constraint_1 },
		0, 0, /* No default value */
		"npn-IdentityList-r16"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct NR_NPN_IdentityInfo_r16, iab_Support_r16),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_NR_NPN_IdentityInfo_r16_oms_1[] = { 2, 5 };
