...
asn_TYPE_descriptor_t asn_DEF_NR_msgA_DMRS_AdditionalPosition_r16_2 = {
	...
	{ 0, &asn_PER_type_NR_msgA_DMRS_AdditionalPosition_r16_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_NR_msgA_MaxLength_r16_6 = {
	...
	{ 0, &asn_PER_type_NR_msgA_MaxLength_r16_constr_6, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_NR_MsgA_DMRS_Config_r16_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct NR_MsgA_DMRS_Config_r16, msgA_PUSCH_DMRS_CDM_Group_r16),
		...
		0,
		{ 0, &asn_PER_memb_NR_msgA_PUSCH_DMRS_CDM_Group_r16_constr_8,  memb_NR_msgA_PUSCH_DMRS_CDM_Group_r16_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 3, offsetof(struct NR_MsgA_DMRS_Config_r16, msgA_PUSCH_NrofPorts_r16),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_msgA_PUSCH_NrofPorts_r16_constr_9,  memb_NR_msgA_PUSCH_NrofPorts_r16_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 2, offsetof(struct NR_MsgA_DMRS_Config_r16, msgA_ScramblingID0_r16),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_msgA_ScramblingID0_r16_constr_10,  memb_NR_msgA_ScramblingID0_r16_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct NR_MsgA_DMRS_Config_r16, msgA_ScramblingID1_r16),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_msgA_ScramblingID1_r16_constr_11,  memb_NR_msgA_ScramblingID1_r16_constraint_1 },
		0, 0, /* No default value */
